...
function createProject(imageURL = [], projectTitle = '', listOfIcons = ['github'], text = '') {
  ...
  title.innerHTML = `Request Header Parser<br>Microservice`
...
function addProject(obj) {
  ...
  obj.projects.forEach(({imageURL, projectTitle, listOfIcons, text}) => {
    portfolioCont.append(createProject(imageURL, projectTitle, listOfIcons, text))
  })
}
